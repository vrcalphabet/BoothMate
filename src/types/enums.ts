...
// console.log(data.events.reverse().map(e => `
//   /** ${e.name_ja} */
//   ${e.slug.replaceAll('-', '_')} = '${e.slug}',`).join(''))
...
export enum BoothEvent {
  ...
  x_neoket = 'x-neoket',
  /** ワンダーフェスティバル 2026冬 */
  wonfes2026winter = 'wonfes2026winter',
  /** ワンダーフェスティバル 2026夏 */
  wonfes2026summer = 'wonfes2026summer',
  /** ワンダーフェスティバル 2025冬 */
  ...
  /** VRF ONLINE -260214- */
  vrf_online_260214 = 'vrf-online-260214',
  /** 出張版！VRCくりえいてぃ部 */
  vrcreative = 'vrcreative',
  /** 出張版！VRCくりえいてぃ部2 */
  vrccreative2 = 'vrccreative2',
  ...
  /** VALENTINE ROSE FES 2026 -day2- */
  valentinerosefes2026_2 = 'valentinerosefes2026-2',
  /** VALENTINE ROSE FES 2026 -day1- */
  valentinerosefes2026_1 = 'valentinerosefes2026-1',
  ...
  /** TOKYO FES Jan.2026 */
  tokyofes_jan2026 = 'tokyofes-jan2026',
  /** TOKYO FES Jan.2025 */
  ...
  /** 技術書典20 */
  techbookfest_20 = 'techbookfest-20',
  /** 技術書典2 */
  techbookfest_2 = 'techbookfest-2',
  /** 技術書典19 */
  techbookfest_19 = 'techbookfest-19',
  /** 技術書典 18 */
  ...
  /** SUPER COMIC CITY 33 */
  supercomiccity33 = 'supercomiccity33',
  ...
  /** SUPER COMIC CITY 関西 31 */
  supercomiccity31_kansai = 'supercomiccity31-kansai',
  /** SUPER COMIC CITY 31 */
  ...
  senka2019 = 'senka2019',
  /** SC2026 Summer */
  sc2026summer = 'sc2026summer',
  /** SC2026 Spring */
  sc2026spring = 'sc2026spring',
  /** SC2025 Winter */
  sc2025winter = 'sc2025winter',
  /** SC2025 Summer */
  sc2025summer = 'sc2025summer',
  /** SC2025 Autumn */
  sc2025autumn = 'sc2025autumn',
  /** SC2024 Summer */
  ...
  /** OSAKA FES Mar. 2026 */
  osakafes_mar2026 = 'osakafes-mar2026',
  /** OSAKA FES Mar.2025 */
  ...
  m3_2015a = 'm3-2015a',
  /** 関西コミティア76 */
  k_comitia76 = 'k-comitia76',
  /** 関西コミティア75 */
  k_comitia75 = 'k-comitia75',
  /** 関西コミティア74 */
  ...
  i_doll56 = 'i-doll56',
  /** 星に願いを 2026 -day2- */
  hoshininegaiwo2026_2 = 'hoshininegaiwo2026-2',
  /** 星に願いを 2026 -day1- */
  hoshininegaiwo2026_1 = 'hoshininegaiwo2026-1',
  /** 星に願いを 2025 -day2- */
  ...
  /** 星に願いを。ONLINE -260705- */
  hoshininegaiwo_online_260705 = 'hoshininegaiwo-online-260705',
  /** 星に願いを。ONLINE -250720- */
  ...
  /** ホロケット15th */
  holoketto15 = 'holoketto15',
  /** ホロケット14th */
  holoketto14 = 'holoketto14',
  /** ホロケット13th */
  ...
  holoketto = 'holoketto',
  /** HARU COMIC CITY 35 */
  harucomiccity35tokyo = 'harucomiccity35tokyo',
  /** HARU COMIC CITY 34 */
  ...
  /** HARU COMIC CITY ONLINE -260322- */
  harucomiccity_online_260322 = 'harucomiccity-online-260322',
  ...
  /** GOOD & VEGA -260830- */
  goodvega_260830 = 'goodvega-260830',
  /** GOOD COMIC CITY ONLINE -250824- */
  goodcomiccity_online_250824 = 'goodcomiccity-online-250824',
  /** GOOD COMIC CITY 32 大阪 */
  good_comiccity32osaka = 'good-comiccity32osaka',
  ...
  /** ゲームマーケット2026春 */
  gamemarket_2026s = 'gamemarket-2026s',
  /** ゲームマーケット2025春 */
  gamemarket_2025s = 'gamemarket-2025s',
  /** ゲームマーケット2025秋 */
  gamemarket_2025a = 'gamemarket-2025a',
  /** ゲームマーケット2024春 */
  ...
  /** ドールズ・パーティー55 */
  dollsparty55 = 'dollsparty55',
  /** ドールズ・パーティー54 */
  dollsparty54 = 'dollsparty54',
  /** ドールズ・パーティー53 */
  ...
  /** ドールショウ78夏 */
  dollshow78 = 'dollshow78',
  /** ドールショウ77冬 */
  dollshow77 = 'dollshow77',
  /** ドールショウ76秋 */
  ...
  /** デジゲー博2025 */
  digigame_expo2025 = 'digigame-expo2025',
  /** デジゲー博2024 */
  ...
  /** デザインフェスタ vol.63 */
  designfesta63 = 'designfesta63',
  /** デザインフェスタ vol.62 */
  designfesta62 = 'designfesta62',
  /** デザインフェスタ vol.61 */
  ...
  /** コスホリックSPECIAL */
  cosholicsp_2025 = 'cosholicsp-2025',
  /** コスホリックSPECIAL */
  cosholicsp = 'cosholicsp',
  /** コスホリック44 */
  cosholic44 = 'cosholic44',
  /** コスホリック43 */
  cosholic43 = 'cosholic43',
  /** コスホリック42 */
  ...
  /** COMITIA157 */
  comitia157 = 'comitia157',
  /** COMITIA156 */
  comitia156 = 'comitia156',
  /** COMITIA155 */
  comitia155 = 'comitia155',
  /** COMITIA154 */
  comitia154 = 'comitia154',
  /** COMITIA153 */
  ...
  /** COMIC CITY VEGA 2026 */
  comiccity_vega2026 = 'comiccity-vega2026',
  ...
  /** COMIC CITY 東京152 */
  comiccity_tokyo152 = 'comiccity-tokyo152',
  /** COMIC CITY 東京 151 */
  ...
  comiccity_spark20_2 = 'comiccity-spark20-2',
  ...
  /** COMIC CITY SPARK ONLINE -251123- */
  comiccity_spark_online_251123 = 'comiccity-spark-online-251123',
  ...
  /** COMIC CITY ONLINE -260607- */
  comiccity_online_260607 = 'comiccity-online-260607',
  /** 超COMIC CITY ONLINE -260510- */
  comiccity_online_260510 = 'comiccity-online-260510',
  /** 超COMIC CITY ONLINE -260118- */
  comiccity_online_260118 = 'comiccity-online-260118',
  ...
  /** COMIC CITY 福岡 64 */
  comiccity_fukuoka64 = 'comiccity-fukuoka64',
  /** COMIC CITY 福岡 63 */
  comiccity_fukuoka63 = 'comiccity-fukuoka63',
  /** COMIC CITY 福岡62 */
  ...
  comic1_10 = 'comic1-10',
  /** こみっく★トレジャー47 */
  comic_treasure_47 = 'comic-treasure-47',
  /** こみっく★トレジャー45 */
  ...
  bunfree25 = 'bunfree25',
  /** 文学フリマ 東京42 */
  bunfree_tokyo42 = 'bunfree-tokyo42',
  /** 文学フリマ 東京41 */
  bunfree_tokyo41 = 'bunfree-tokyo41',
  /** 文学フリマ 東京40 */
  ...
  /** エアブー春の感謝祭 -20260412- */
  air_boo_260412 = 'air-boo-260412',
  /** エアブーゆくとしくるとし感謝祭 */
  air_boo_1228 = 'air-boo-1228',
  ...
  /** VketReal 2026 Summer */
  VketReal2026Summer = 'VketReal2026Summer',
  /** VketReal 2025 Winter */
  VketReal2025Winter = 'VketReal2025Winter',
  /** VketReal 2025 Summer */
  VketReal2025Summer = 'VketReal2025Summer',
  /** バーチャルマーケット2026 Summer */
  Vket2026Summer = 'Vket2026Summer',
  /** バーチャルマーケット2025 Winter */
  Vket2025Winter = 'Vket2025Winter',
